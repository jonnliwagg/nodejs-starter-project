...
router.get('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const queryHandlings = yield queryHandlingService_1.default.findAll();
...
router.get('/:id', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingQueryHandling = yield queryHandlingService_1.default.findById(req.params.id);
...
router.put('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield queryHandlingService_1.default.update(queryHandlingId, Object.assign({}, req.body));
...
router.delete('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const queryHandlingId = req.params.id;
        yield queryHandlingService_1.default.deleteByPrimaryKey(queryHandlingId);
        res.status(200).json({
...
router.post('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newQueryHandling = yield queryHandlingService_1.default.save(payload);
