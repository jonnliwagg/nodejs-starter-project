...
router.get('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const employees = yield employeeService_1.default.findAll();
...
router.get('/:id', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingEmployee = yield employeeService_1.default.findById(req.params.id);
        if (existingEmployee) {
...
router.put('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield employeeService_1.default.update(employeeId, Object.assign({}, req.body));
...
router.delete('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const employeeId = req.params.id;
        yield employeeService_1.default.deleteByPrimaryKey(employeeId);
        res.status(200).json({
...
router.post('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newEmployee = yield employeeService_1.default.save(payload);
