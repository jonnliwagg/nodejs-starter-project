...
router.get('/:id', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingProduct = yield productService_1.default.findById(req.params.id);
        if (existingProduct) {
...
router.put('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield productService_1.default.update(productId, Object.assign({}, req.body));
...
router.delete('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const productId = req.params.id;
        yield productService_1.default.deleteByPrimaryKey(productId);
        res.status(200).json({
...
router.post('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newProduct = yield productService_1.default.save(payload);
