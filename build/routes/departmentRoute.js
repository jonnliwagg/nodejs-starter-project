...
router.get('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const departments = yield departmentService_1.default.findAll();
...
router.get('/:id', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingDepartment = yield departmentService_1.default.findById(parseInt(req.params.id));
        if (existingDepartment) {
            resp.status(201).json(existingDepartment);
        }
        else {
...
router.put('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield departmentService_1.default.update(departmentId, Object.assign({}, req.body));
...
router.delete('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const departmentId = parseInt(req.params.id);
        yield departmentService_1.default.deleteByPrimaryKey(departmentId);
        res.status(200).json({
...
router.post('/', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newDepartment = yield departmentService_1.default.save(payload);
